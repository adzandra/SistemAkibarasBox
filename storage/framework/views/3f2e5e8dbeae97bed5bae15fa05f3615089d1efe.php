<header class="header shop">
                ...
                <div class="col-lg-2 col-md-2 col-12">
                    ...
                    <div class="logo">
                        <?php
                            $settings=DB::table('settings')->get();
                        ?>     
                        <a href="index.html"><img src="<?php echo e(asset('backend/img/logo.png')); ?>" alt="logo"></a>               
    ...
    <!--/ End Header Inner -->
</header><?php /**PATH C:\xampp\htdocs\SistemAkibarasBox\resources\views/frontend/layouts/header.blade.php ENDPATH**/ ?>