              ...
              ?>
                <tr>
                    ...
                    <td>
                        ...
                        <?php else: ?>
                            <img src="<?php echo e(asset('backend/img/thumbnail-default.png')); ?>" class="img-fluid" style="max-width:80px" alt="avatar.png">
                        <?php endif; ?>
                    </td>
                    <td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SistemAkibarasBox\resources\views/backend/category/index.blade.php ENDPATH**/ ?>