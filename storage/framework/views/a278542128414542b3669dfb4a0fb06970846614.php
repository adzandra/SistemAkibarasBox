...
<?php $__env->startSection('title','AKIBARA BOX || HOME PAGE'); ?>
                    ...
                    <?php if($cat->is_parent==1): ?>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="single-banner">
                                ...
                                <?php else: ?>
                                    <img src="<?php echo e(asset('backend/img/thumbnail-default.png')); ?>" alt="#">
                                <?php endif; ?>
                                <div class="content">
                            ...
                            <div class="single-list">
                                ...
                                <div class="col-lg-6 col-md-6 col-12 no-padding">
                                    <div class="content">
                                       ...
                                       <p class="price with-discount"> Disc <?php echo e(number_format($product->discount,0)); ?>%</p>
                                    </div>
                                </div>
                                </div>
                            </div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SistemAkibarasBox\resources\views/frontend/index.blade.php ENDPATH**/ ?>